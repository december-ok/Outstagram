...
export const posts = [
  ...
  },
  {
    ...
    article: "So soon after equalling a Serie A goalscoring record at the weekend, Cristiano Ronaldo has been brought crashing back down to earth on a night of Champions League frustration. The hope was when Ronaldo joined Juve in July 2018 he would be the man to help the Bianconeri finally end a wait for glory on Europe's top stage that now stretches 24 years. It's not going to plan. Having scored in a record-equalling 11th consecutive league match in Saturday's win over SPAL, the Portugal forward looked ready to head into Wednesday evening's game away at Lyon with goals and the quarter-finals on his mind.",
    likedUsers: [
